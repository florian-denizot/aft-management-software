...
JHtml::script('com_aftms/jquery.chained.min.js', false, true);
...
<form action="<?php echo JRoute::_('index.php?option=com_aftms&view=' . $this->getName() . '&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	...
	<div class="form-horizontal">
        ...
        <?php echo $this->form->getControlGroup('groupid'); ?>
        <?php echo $this->form->getControlGroup('sessionid'); ?>
        <?php echo $this->form->getControlGroup('start_date'); ?>
        <?php echo $this->form->getControlGroup('end_date'); ?>
        <?php echo $this->form->getControlGroup('date_pattern'); ?>
        <?php echo $this->form->getControlGroup('campusid'); ?>
        <?php echo $this->form->getControlGroup('classroomid'); ?>
        <?php echo $this->form->getControlGroup('price_override'); ?>
